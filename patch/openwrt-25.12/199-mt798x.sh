...
sed -i '$a https://mirrors.pku.edu.cn/openwrt/releases/25.12.1/targets/mediatek/filogic/kmods/6.12.74-1-60d938adcb727697d3015e4285d4c290/packages.adb' /etc/apk/repositories.d/distfeeds.list
sed -i '$a https://mirrors.pku.edu.cn/openwrt/releases/25.12.1/targets/mediatek/filogic/packages/packages.adb' /etc/apk/repositories.d/distfeeds.list
